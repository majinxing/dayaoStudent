//
//  MJXHaveToRemindViewController.m
//  XinSuiFang
//
...
@interface MJXHaveToRemindViewController ()<UITableViewDataSource,UITableViewDelegate,MJXPatientsNodeInfoTableViewCellDelegate>
@property (nonatomic,strong)UITableView * tableView;
@property (nonatomic,strong)NSMutableArray * patientsArray;//患者数组
@end

@implementation MJXHaveToRemindViewController

//
//  AllOrPersonalDataViewController.m
//  WisdomHall
//
...
@interface AllOrPersonalDataViewController ()<UIScrollViewDelegate>
...
@implementation AllOrPersonalDataViewController
...
-(void)initVCArray{
    ...
    DataDownloadViewController * allMVC = [[DataDownloadViewController alloc] init];
    allMVC.classModel = _classModel;
    allMVC.type = @"classModel";
    allMVC.function = @"6";
//    _pictureType = @"QAPicture";
    
    PersonalUploadDataViewController * inMVC = [PersonalUploadDataViewController alloc];
    inMVC.classModel = _classModel;
    inMVC.type = @"classModel";
    inMVC.function = @"6";
//    _pictureType = @"QAPicture";
...
-(void)setUpScrollView{
    ...
    _scrollView.contentSize = CGSizeMake(APPLICATION_WIDTH/2, 40);
    ...
    for (int i = 0; i<title.count; i++) {
        ...
        button.frame = CGRectMake(APPLICATION_WIDTH/title.count*i,0,APPLICATION_WIDTH/title.count,40);
    ...
    //设置提示条目
    _lineView = [[UIView alloc]initWithFrame:CGRectMake(0,35,APPLICATION_WIDTH/title.count, 1)];
    //背景颜色
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    //    //设定滑动主视图时候滑块随主视图滑动
    _lineView.frame = CGRectMake(scrollView.contentOffset.x/APPLICATION_WIDTH*APPLICATION_WIDTH/2, 35,APPLICATION_WIDTH/2,1);

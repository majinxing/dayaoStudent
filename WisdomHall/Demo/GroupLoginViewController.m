...
//    [IMHttpAPI createGroup:@"name_19" master:1 members:@[@"1",@"2"] success:^(NSDictionary *groupId) {        NSLog(@"%@",groupId);
//    } fail:^(NSString *error) {
//        NSLog(@"%@",error);
//    }];
...
//    NSDictionary *obj = [NSDictionary dictionaryWithObject:[NSNumber numberWithLongLong:uid] forKey:@"uid"];
    ...
    NSDictionary * obj = [[NSDictionary alloc] initWithObjectsAndKeys:[NSNumber numberWithLongLong:uid],@"uid",@"112233",@"user_name",@"2",@"platform_id",nil];
